            ...
            <div css={s.right}>
                ...
                <div css={s.board}>
                    {loading ? (
                        ...
                        >
                            <span css={s.postIdSpan}>{post.id}</span> | <spancss={s.postTitleSpan}>{post.title}</spancss=> | <span>{post.writerId}</span> | <span>{new Date(post.createdAt).toLocaleDateString()}</span>
                        </div>
                        ))
                    )}
                </div>
