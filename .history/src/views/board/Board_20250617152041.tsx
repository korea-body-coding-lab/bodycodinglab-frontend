            ...
            <div css={s.right}>
                ...
                <div css={s.board}>
                    {loading ? (
                        ...
                        >
                            <span css={s.postIdSpan}>{post.id}</span> | <span css={s.postTitleSpan}>{post.title}</span> | <span css={s.postWriterSpan}>{post.writerId}</span> | <span>{new Date(post.createdAt).toLocaleDateString()}</span>
                        </div>
                        ))
                    )}
                </div>
